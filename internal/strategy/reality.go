...
// clientPrivKey and clientSalt are this connection's ephemeral material; both end
// up inside the 256-byte padding block, whose size on the wire is unchanged.
